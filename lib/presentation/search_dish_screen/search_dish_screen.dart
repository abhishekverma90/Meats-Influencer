...
class SearchDishScreen extends GetWidget<SearchDishController> {
  @override
                ...
                child: Obx(
                  () => ListView.separated(
                    ...
                    itemCount: controller
                        .searchDishModelObj.value.listpizzaItemList.length,
                    itemBuilder: (context, index) {
                      ListpizzaItemModel model = controller
                          .searchDishModelObj.value.listpizzaItemList[index];
